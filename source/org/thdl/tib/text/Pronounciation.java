...
public class Pronounciation
{
	...
	public Pronounciation ( String which ) throws Exception
	{	
		setRules ( which ) ;
		lastWordOriginal = "" ;
	}
	...
	/**
	 * pronounciation standard enumerator
	 */
	 ...
	 * setRules
	 */
	protected void setRules ( String phoneticSystemName ) throws Exception
	{
		if ( phoneticSystemName == "THDL" )
		{
			setThdl () ;
		}
		else
	...
	protected void setThdl () throws Exception
	{
		...
		Rule [] thdlRules = 
		{
			...
			//
			new Rule ( Rule.STARTS_WITH_BORDERS_VOWEL, "py", Rule.REPLACE_MATCH, "ch" ), 
			new Rule ( Rule.STARTS_WITH_BORDERS_VOWEL, "Py", Rule.REPLACE_MATCH, "ch" ), 
	...
	protected String processWord ( String in ) throws Exception
	{
        ...
        in = in.replaceAll ( "P", "ph" ) ;
        in = in.replaceAll ( "S", "sh" ) ;
        in = in.replaceAll ( "T", "th" ) ;
        in = in.replaceAll ( "X", "ts" ) ;
        in = in.replaceAll ( "Q", "tsh" ) ;
	...
	public String process ( String in ) throws Exception
	{
		...
		String [] matchWords = in.split ( "[^a-z']+" ) ;
	...
	public static void main ( String [] args )
	{
		try
		{
			Pronounciation p = new Pronounciation ( "THDL" ) ;
