...
public class WylieToUnicodeUpdateProcessorFactory extends FieldMutatingUpdateProcessorFactory {
    ...
    return new FieldValueMutatingUpdateProcessor(getSelector(), next) {
      protected Object mutateValue(final Object src) {
        if (src instanceof CharSequence) {
          ...
          return BasicTibetanTranscriptionConverter.wylieToUnicode(s.toString());
        }
        else 
        {
        	return src;
